...
In this task, we will browse the Azure QuickStart gallery, access the Azure QuickStart GitHub repository, and deploy a template that creates a virtual machine. 
...
2. Open a new browser tab or window and enter `https://github.com/Azure/azure-quickstart-templates/tree/master/quickstarts/microsoft.compute/vm-simple-windows` to access the **Deploy a simple Windows VM** template page within the Azure QuickStart GitHub repository. Note that this repository hosts a great variety of template sources.

3. Scroll down on the **Deploy a simple Windows VM** template page and click the **Deploy to Azure** button. Your browser session will be automatically redirected to the [Azure portal](http://portal.azure.com/).
